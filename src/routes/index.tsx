...
function ReviewPage() {
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    try {
      ...
      // Every customer goes to Google, regardless of rating — Google's 2026
      // policy prohibits routing only happy customers there ("review
      // gating"), and it's actively enforced. Low ratings still privately
      // alert the owner by email (handled server-side in submitReview) so
      // staff can follow up, in addition to — not instead of — the public
      // review. One form, one submit, no second survey either way.
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-[30rem] flex-col px-5 pb-16 pt-10">
      ...
      <footer className="mt-8 pt-4 text-center text-[0.68rem] tracking-[0.2em] text-muted-foreground/70 uppercase">
